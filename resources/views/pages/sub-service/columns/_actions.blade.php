...
{{--   data-action="{{ route('service.show',$service->id) }}" data-method="get"><i class="fa-solid fa-eye"></i></a>--}}
<a href="#" class="has_action btn btn-icon btn-light-warning me-5 " data-type="edit"
   data-action="{{ route('sub-service.edit',$service->id) }}">
    <i class="fa-solid fa-pen-to-square"></i>
</a>
<a href="#" class="delete_btn btn btn-icon btn-light-danger me-5  delete_btn" data-type="delete" data-action="{{ route('sub-service.destroy',$service->id) }}" >
