...
<a href="#" class="has_action element btn btn-icon btn-light-primary me-5 " data-type="show"
   data-action="{{ route('category.show',$category->id) }}" data-method="get"><i class="fa-solid fa-eye"></i></a>
<a href="#" class="has_action btn btn-icon btn-light-warning me-5 " data-type="edit"
   data-action="{{ route('category.edit',$category->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
