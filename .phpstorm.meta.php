...
'filesystems.links./home/sayed/Downloads/slide/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','wallet.math.scale','wallet.cache.driver',
'wallet.cache.ttl','wallet.lock.driver','wallet.lock.seconds','wallet.internal.clock','wallet.internal.connection',
'wallet.internal.database','wallet.internal.dispatcher','wallet.internal.json','wallet.internal.lock','wallet.internal.math',
'wallet.internal.state','wallet.internal.storage','wallet.internal.translator','wallet.internal.uuid','wallet.internal.identifier',
'wallet.services.assistant','wallet.services.atm','wallet.services.atomic','wallet.services.basket','wallet.services.bookkeeper',
'wallet.services.regulator','wallet.services.cast','wallet.services.consistency','wallet.services.discount','wallet.services.eager_loader',
'wallet.services.exchange','wallet.services.formatter','wallet.services.prepare','wallet.services.purchase','wallet.services.tax',
'wallet.services.transaction','wallet.services.transfer','wallet.services.wallet','wallet.repositories.transaction','wallet.repositories.transfer',
...
'wallet.assemblers.extra','wallet.assemblers.option','wallet.assemblers.transaction','wallet.assemblers.transfer_lazy','wallet.assemblers.transfer',
'wallet.assemblers.transaction_created_event','wallet.assemblers.transaction_query','wallet.assemblers.transfer_query','wallet.events.balance_updated','wallet.events.wallet_created',
'wallet.events.transaction_created','wallet.transaction.table','wallet.transaction.model','wallet.transfer.table','wallet.transfer.model',
'wallet.wallet.table','wallet.wallet.model','wallet.wallet.creating','wallet.wallet.default.name','wallet.wallet.default.slug',
'wallet.wallet.default.meta','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'sanctum.csrf-cookie','telescope','user.auth.checkPhone',
'user.auth.sendOtp','user.auth.verifyOtp','user.auth.register','user.auth.question','user.auth.setPassword','storage.local',);
        registerArgumentsSet('views', 
'pages.area.action','pages.area.columns._actions','pages.area.columns._user','pages.area.form','pages.area.index',
'pages.area.index3','pages.area.modals._add-auth-app','pages.area.modals._add-one-time-password','pages.area.modals._add-schedule','pages.area.modals._add-task',
'pages.area.modals._update-details','pages.area.modals._update-email','pages.area.modals._update-password','pages.area.modals._update-role','pages.category.action',
'pages.category.columns._actions','pages.category.form','pages.category.index','pages.contractor-request.columns._actions','pages.contractor-request.form',
'pages.contractor-request.index','pages.conversation.columns._actions','pages.conversation.form','pages.conversation.index','pages.discount-code.columns._actions',
'pages.discount-code.form','pages.discount-code.index','pages.invoice.columns._actions','pages.invoice.form','pages.invoice.index',
'pages.level.columns._actions','pages.level.form','pages.level.index','pages.model.index','pages.order.2index',
'pages.order.3index','pages.order.4index','pages.order.Oldindex','pages.order.columns._actions','pages.order.form',
'pages.order.index','pages.order.show','pages.payment.columns._actions','pages.payment.form','pages.payment.index',
'pages.provider.columns._actions','pages.provider.form','pages.provider.index','pages.review.columns._actions','pages.review.form',
'pages.review.index','pages.section.action','pages.section.columns._actions','pages.section.form','pages.section.index',
'pages.service.action','pages.service.columns._actions','pages.service.columns._user','pages.service.form','pages.service.index',
'pages.service.modals._add-auth-app','pages.service.modals._add-one-time-password','pages.service.modals._add-schedule','pages.service.modals._add-task','pages.service.modals._update-details',
'pages.service.modals._update-email','pages.service.modals._update-password','pages.service.modals._update-role','pages.setting.columns._actions','pages.setting.form',
'pages.setting.index','pages.space.columns._actions','pages.space.form','pages.space.index','pages.sub-service.action',
'pages.sub-service.columns._actions','pages.sub-service.columns._user','pages.sub-service.form','pages.sub-service.index','pages.sub-service.modals._add-auth-app',
'pages.sub-service.modals._add-one-time-password','pages.sub-service.modals._add-schedule','pages.sub-service.modals._add-task','pages.sub-service.modals._update-details','pages.sub-service.modals._update-email',
'pages.sub-service.modals._update-password','pages.sub-service.modals._update-role','pages.transaction.columns._actions','pages.transaction.form','pages.transaction.index',
'pages.user.columns._actions','pages.user.form','pages.user.index','pages.wallet.columns._actions','pages.wallet.form',
'pages.wallet.index','pages.warranty.columns._actions','pages.warranty.form','pages.warranty.index','welcome',
