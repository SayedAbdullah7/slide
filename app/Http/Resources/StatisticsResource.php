    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'general_vision' => [
                ...
                'distributed_profits' => [
                    'value' => $this->resource['general_vision']['distributed_profits']['value'],
                    'formatted' => $this->resource['general_vision']['distributed_profits']['formatted'],
                ],
                'profit_percentage' => (double)$this->resource['general_vision']['profit_percentage'],
                'profit_percentage_float' => (float)$this->resource['general_vision']['profit_percentage'],
            ],
            'portfolio_performance' => [
                ...
                'distributed_profits' => [
                    'value' => $this->resource['portfolio_performance']['distributed_profits']['value'],
                    'formatted' => $this->resource['portfolio_performance']['distributed_profits']['formatted'],
                ],
                'total_invested' => [
